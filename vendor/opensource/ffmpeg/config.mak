...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-demuxers --enable-decoders --enable-decoder=flac --disable-decoder=mjpeg --disable-stripping --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-encoders --disable-muxers --enable-muxer=spdif --disable-devices --enable-parsers --disable-bsfs --disable-protocols --enable-protocol=file --enable-protocol=http --enable-protocol=https --disable-filters --disable-avdevice --enable-cross-compile --cross-prefix=arm-eabi- --disable-asm --enable-neon --enable-armv5te --disable-postproc --disable-logging --extra-cflags='-fPIC -DANDROID -I../../../bionic/libc/include/ -I../../../bionic/libc/arch-arm/include -I../../../bionic/libc/kernel/common -I../../../bionic/libc/kernel/arch-arm' --extra-ldflags='-Wl,-T,../../../prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/arm-linux-androideabi/lib/ldscripts/armelf_linux_eabi.x                      -Wl,-rpath-link=../../../out/target/product/hi3650/system/lib -L../../../out/target/product/hi3650/system/lib -nostdlib                      ../../../prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/lib/gcc/arm-linux-androideabi/4.9.x-google/crtbegin.o                      ../../../prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/lib/gcc/arm-linux-androideabi/4.9.x-google/crtend.o -lc -lm -ldl'
prefix=/usr/local
...
ARFLAGS=rcD
AR_O=$@
RANLIB=arm-eabi-ranlib -D
STRIP=echo skipping strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -Dstrtod=avpriv_strtod -I$(SRC_PATH)/compat/float
CFLAGS=  -fPIC -DANDROID -I../../../bionic/libc/include/ -I../../../bionic/libc/arch-arm/include -I../../../bionic/libc/kernel/common -I../../../bionic/libc/kernel/arch-arm -march=armv5te -std=c99 -fomit-frame-pointer -marm -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
OBJCFLAGS=  
ASFLAGS=  -fPIC -DANDROID -I../../../bionic/libc/include/ -I../../../bionic/libc/arch-arm/include -I../../../bionic/libc/kernel/common -I../../../bionic/libc/kernel/arch-arm -march=armv5te -g
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DEPWINDRES=arm-eabi-gcc
DOXYGEN=doxygen
LDFLAGS= -Wl,-T,../../../prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/arm-linux-androideabi/lib/ldscripts/armelf_linux_eabi.x -Wl,-rpath-link=../../../out/target/product/hi3650/system/lib -L../../../out/target/product/hi3650/system/lib -nostdlib ../../../prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/lib/gcc/arm-linux-androideabi/4.9.x-google/crtbegin.o ../../../prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/lib/gcc/arm-linux-androideabi/4.9.x-google/crtend.o -lc -lm -ldl  -march=armv5te -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=

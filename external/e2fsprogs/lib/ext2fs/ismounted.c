 ...
 */
_UNUSED static int check_loop_mounted(_UNUSED const char *mnt_fsname, _UNUSED dev_t mnt_rdev,
				_UNUSED dev_t file_dev, _UNUSED ino_t file_ino)
{
...
#else
#ifdef __GNUC__
 #pragma message "Can't use getmntent or getmntinfo to check for mounted filesystems!"
#endif
		*mount_flags = 0;
#endif /* HAVE_GETMNTINFO */
#endif /* HAVE_SETMNTENT */
